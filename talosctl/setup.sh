...
talosctl apply-config --insecure --nodes 172.16.10.5 --file _out/controlplane.yaml --force
...
# Create Worker Nodes
talosctl apply-config --insecure --nodes 172.16.10.6 --file _out/worker.yaml --force
talosctl apply-config --insecure --nodes 172.16.10.7 --file _out/worker.yaml --force
